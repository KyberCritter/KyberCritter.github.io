...
<div class="relative max-w-4xl mx-auto">
  <!-- Carousel Container -->
  <div class="relative overflow-hidden rounded-xl shadow-2xl bg-gray-900">
    <!-- Slides -->
    ...
    <!-- Previous Button -->
    <button id="prev" class="absolute left-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white text-gray-900 rounded-full p-3 shadow-lg transition-all hover:scale-110">
      <i class="fas fa-chevron-left text-xl"></i>
    </button>

    <!-- Next Button -->
    <button id="next" class="absolute right-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white text-gray-900 rounded-full p-3 shadow-lg transition-all hover:scale-110">
  ...
  <div class="flex justify-center gap-2 mt-6">
    <button class="dot w-3 h-3 rounded-full bg-accent transition-all" data-index="0"></button>
    <button class="dot w-3 h-3 rounded-full bg-gray-300 transition-all" data-index="1"></button>
    <button class="dot w-3 h-3 rounded-full bg-gray-300 transition-all" data-index="2"></button>
    <button class="dot w-3 h-3 rounded-full bg-gray-300 transition-all" data-index="3"></button>
  </div>
</div>
